...
[![Build Status](https://travis-ci.org/ernstbe/fosite.svg?branch=master)](https://travis-ci.org/ernstbe/fosite?branch=master)
[![Coverage Status](https://coveralls.io/repos/ernstbe/fosite/badge.svg?branch=master&service=github&foo)](https://coveralls.io/github/ernstbe/fosite?branch=master)
[![Go Report Card](https://goreportcard.com/badge/ernstbe/fosite)](https://goreportcard.com/report/ernstbe/fosite)
...
```
go get github.com/ernstbe/fosite-example
cd $GOPATH/src/github.com/ernstbe/fosite-example
dep ensure
go install github.com/ernstbe/fosite-example
fosite-example
```

There should be a server listening on [localhost:3846](https://localhost:3846/). You can check out the example's
source code [here](https://github.com/ernstbe/fosite-example/).
...
that is covered in Fosite, feel free to create an [issue](https://github.com/ernstbe/fosite/issues). Please be
...
```
go get -d github.com/ernstbe/fosite
```
...
There is an API documentation available at [godoc.org/ernstbe/fosite](https://godoc.org/github.com/ernstbe/fosite).
...
to the [example app](https://github.com/ernstbe/fosite-example/) for more details.

This little code snippet sets up a full-blown OAuth2 and OpenID Connect example.

```go
import "github.com/ernstbe/fosite"
import "github.com/ernstbe/fosite/compose"
import "github.com/ernstbe/fosite/storage"
...
* Fosite ships with an example app that runs in your browser: [Example app](https://github.com/ernstbe/fosite-example/).
...
```
go get -d github.com/ernstbe/fosite
cd $GOPATH/src/github.com/ernstbe/fosite
git status
...
* [agtorre](https://github.com/agtorre):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Aagtorre),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Aagtorre).
* [danielchatfield](https://github.com/danielchatfield):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Adanielchatfield),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Adanielchatfield).
* [leetal](https://github.com/leetal):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Aleetal),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Aleetal).
* [jrossiter](https://github.com/jrossiter):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Ajrossiter),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Ajrossiter).
* [jrossiter](https://github.com/jrossiter):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Ajrossiter),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Ajrossiter).
* [danilobuerger](https://github.com/danilobuerger):
  [contributions](https://github.com/ernstbe/fosite/issues?q=author%3Adanilobuerger),
  [participations](https://github.com/ernstbe/fosite/issues?q=commenter%3Adanilobuerger).
